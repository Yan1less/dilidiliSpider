...
public class Utiils {
    ...
    @Test
    public void xxx(){
        //发行时间<a href="/anime/201807/" title="2018年4月番剧">2018年4月</a>
        String time = "<a href=\"/anime/200001810/\" title=\"2018年4月番剧\">2018年4月</a>";
        Pattern p2 = Pattern.compile("[\\s|\\S]*<a href=\"/anime/\\d*/\" title=\"\\d*年\\d*月番剧\">(\\d*[\u4E00-\u9FA5]*\\d*[\u4E00-\u9FA5]*)</a>[\\s|\\S]*");
        Matcher m2 = p2.matcher(time);
        if (m2.matches()){
    ...
    @Test
    public void td(){
        String comp1 = "<img src=\"https://ss0.baidu.com/6ONWsjip0QIZ8tyhnq/it/u=515150241,2811387496&amp;fm=58\">";
        String comp="<img src=\"http://www.dilidili.wang/uploads/allimg/161118/1_1633465201.jpg  &#10;\">";
        String a = this.getImgName(comp1);
    ...
    public String getImgName(String imgSrc) {
        ...
        String ImgName = "";
        Pattern pattern = Pattern.compile("<img src=\"http://www\\.dilidili\\.wang/uploads/[\\s|\\S]*/([\\s|\\S]*)\">");
        Matcher matcher = pattern.matcher(imgSrc);
        if(matcher.matches())
    ...
    public String getImgName2(String imgSrc){
        String ImgName = "";
        Pattern compile = Pattern.compile("<img src=\"http://www\\.dilidili\\.wang/+images/([\\s|\\S]*)\">");
    ...
    public String getImgName3(String imgSrc){
        ...
        String ImgName = "";
        Pattern compile = Pattern.compile("<img src=\"http://www\\.dilidili\\.wang//uploads/([\\s|\\S]*)\">");
        Matcher matcher = compile.matcher(imgSrc);
        if(matcher.matches()) {
            ImgName = matcher.group(1);
            ImgName = ImgName.replace("/","_");
    ...
    public void xxxx(){
        ...
        System.out.println(temp.substring(temp.length()-12,temp.length()));
    }
    //设置link
    ...
    public void ExcuteInsert(Animate bean,SqlSession sqlSession){
        ...
        try {
            ...
            int res = mapper.InsertDatas(bean);
